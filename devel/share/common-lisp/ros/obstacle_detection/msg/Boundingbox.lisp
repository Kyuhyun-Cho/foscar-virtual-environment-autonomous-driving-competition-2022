...
(cl:defmethod cl:initialize-instance :after ((m <Boundingbox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Boundingbox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_detection-msg:<Boundingbox> is deprecated: use obstacle_detection-msg:Boundingbox instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:x-val is deprecated.  Use obstacle_detection-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:y-val is deprecated.  Use obstacle_detection-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:z-val is deprecated.  Use obstacle_detection-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:volume-val is deprecated.  Use obstacle_detection-msg:volume instead.")
  (volume m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:distance-val is deprecated.  Use obstacle_detection-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Boundingbox>)))
  ...
  "obstacle_detection/Boundingbox")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Boundingbox)))
  "Returns string type for a message object of type 'Boundingbox"
  "obstacle_detection/Boundingbox")
