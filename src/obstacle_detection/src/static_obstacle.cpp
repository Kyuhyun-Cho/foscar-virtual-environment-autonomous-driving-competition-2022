...
void dynamicParamCallback(obstacle_detection::st_hyper_parameterConfig &config, int32_t level) {
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "static_obstacle");
  ros::NodeHandle nh;

  dynamic_reconfigure::Server<obstacle_detection::st_hyper_parameterConfig> server;
  dynamic_reconfigure::Server<obstacle_detection::st_hyper_parameterConfig>::CallbackType f;
