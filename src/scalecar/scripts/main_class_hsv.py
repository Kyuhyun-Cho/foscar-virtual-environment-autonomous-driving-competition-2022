...
class Controller():
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/image_jpeg/compressed", CompressedImage, self.lane_callback) 
...
# ========== preprocessing via HSV ==========================
        ...
        if self.initialized == False:
            ...
            cv2.createTrackbar('low_H', 'Simulator_Image', 30, 255, nothing)
            cv2.createTrackbar('low_S', 'Simulator_Image', 100, 255, nothing)
            cv2.createTrackbar('low_V', 'Simulator_Image', 200, 255, nothing)
