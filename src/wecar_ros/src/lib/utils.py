...
class vaildObject :
    ...
    # objectInfoCB함수를 통해 얻은 전체 장애물 리스트를 all_object라는 변수에 옮겨 담는 함수 -> 왜 일을 두 번 하는지 모르겠음
    ...
    # WeBot 의 현재 위치 값과 all_object에 있는 장애물들의 정보를 연산하여 global_object와 local_object로 나누는 함수
    def calc_vaild_obj(self, ego_pose):  # x, y, heading
        ...
        tmp_theta=ego_pose[2] # ego_pose[2] == WeBot 헤딩값 
        tmp_translation=[ego_pose[0],ego_pose[1]] # ego_pose[0] == WeBot x좌표 , ego_pose[1] == WeBot y좌표
